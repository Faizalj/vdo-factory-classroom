...
### 🎬 Core Workflows
- `complete-video-factory.json` - **Workflow v1.0** (Google Sheets + Reddit)
- `complete-video-factory-v1.2-improved.json` - **Workflow v1.2** (Supabase + AI Content + Postiz) ⭐ **แนะนำ**

### 📖 Documentation
- `workflow-guide.md` - คำแนะนำการใช้งาน v1.0 ทีละขั้นตอน
- `workflow-v1.2-guide.md` - **คำแนะนำการใช้งาน v1.2** ⭐ **ใหม่**
- `migration-v1.0-to-v1.2.md` - **คู่มือการอัปเกรดจาก v1.0 เป็น v1.2** ⭐ **ใหม่**
...
## 🎯 เลือก Workflow Version

### 🆚 v1.0 vs v1.2

| ฟีเจอร์ | v1.0 (Stable) | v1.2 (Advanced) ⭐ |
|---------|---------------|-------------------|
| **Database** | Google Sheets | Supabase PostgreSQL |
| **Content Source** | Reddit เท่านั้น | Reddit + AI Generation |
| **Social Media** | YouTube เท่านั้น | YouTube + Postiz Multi-platform |
| **Performance** | ปกติ | **3-4x เร็วขึ้น** |
| **Scalability** | จำกัด | Enterprise-ready |
| **Setup Complexity** | ง่าย | ปานกลาง |

### 💡 คำแนะนำการเลือก

**เลือก v1.0 เมื่อ:**
- ใหม่กับ Video Factory
- ต้องการความง่าย
- ใช้ Google Sheets อยู่แล้ว

**เลือก v1.2 เมื่อ:** ⭐ **แนะนำ**
- ต้องการประสิทธิภาพสูง
- ต้องการ AI content generation
- ต้องการ multi-platform posting
- พร้อม setup ขั้นสูง

## 🚀 ขั้นตอนการใช้งาน v1.0
...
## 🚀 ขั้นตอนการใช้งาน v1.2 ⭐

### Quick Start v1.2
1. **Import Workflow**: ดาวน์โหลด `complete-video-factory-v1.2-improved.json`
2. **Setup Supabase**: สร้าง database และ table
3. **Configure Credentials**: Supabase, OpenAI, Postiz 
4. **Set Content Mode**: เลือก `"generate_content": "ai"` สำหรับ AI content
5. **Run Workflow**: รันและได้วิดีโอพร้อม auto-schedule!

📖 **คู่มือละเอียด**: [workflow-v1.2-guide.md](./workflow-v1.2-guide.md)
🔄 **Migration Guide**: [migration-v1.0-to-v1.2.md](./migration-v1.0-to-v1.2.md)
